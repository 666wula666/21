...
def index(request):
    ...
    return render(request, 'index.html', {'session': request.session, 'passages': passages})
...
def blogarticle(request):
    return render(request, 'blog/article.html', {'session': request.session})


def doctor(request):
    return render(request, 'doctor.html', {'session': request.session})


def history(request):
    return render(request, 'history.html', {'session': request.session})


def vedio(request):
    return render(request, 'vedio.html', {'session': request.session})
